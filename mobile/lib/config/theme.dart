...
class Shop4MeTheme {
  ...
  static TextTheme _getBaseTextTheme(FontSize fontSize) {
    ...
    return TextTheme(
      headlineMedium: TextStyle(fontSize: 24 * scaleFactor, fontWeight: FontWeight.bold, color: Colors.black),
      titleLarge: TextStyle(fontSize: 20 * scaleFactor, fontWeight: FontWeight.bold, color: Colors.black),
